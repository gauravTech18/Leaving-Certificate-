...
<body>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php">Leaving Certificate</a>
                        
                          <a class="navbar-brand" href="index.php"><br><br><br>
                            <br><br><br><br>
                            <br>GOVERMENT POLYTECHNIC AWASARI(KH)</a>
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/bg-img/clg.jpg);">
        <br>
        <br>
        <br>
        <br>
        <br>
        <br>
        <link href="css/responsive/responsive1.css" rel="stylesheet1">
       
      <center></center>  <img src="img/bg-img/point.png" height="50px" length="50px"></center>
