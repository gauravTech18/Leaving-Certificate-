...
<head>
    ...
    <title>Forgot Password | Leaving Certificate</title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                 <h3 style="font-weight: bold;color: blue">Leaving Certificate</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="text" name="mobile" placeholder="Enroll No" required="true">
